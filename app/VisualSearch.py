...
import sqlite3
from keras.applications.vgg19 import preprocess_input as PP
...
class VisualSearch():
    ...
    def run(self, path_image, model=app.config["MODEL_NAME"], algorithm='brute', metric='cosine', nb_imgs=80, remove_not_white=False):
